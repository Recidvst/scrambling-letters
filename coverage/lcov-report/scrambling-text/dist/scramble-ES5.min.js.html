...
<html lang="en">
<head>
    <title>Code coverage report for scrambling-text/dist/scramble-ES5.min.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\index.html">All files</a> / <a href="index.html">scrambling-text/dist</a> scramble-ES5.min.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">"use strict";function <span class="fstat-no" title="function not covered" >_instanceof(</span>t,e){<span class="cstat-no" title="statement not covered" >return null!=e&amp;&amp;"undefined"!=typeof Symbol&amp;&amp;e[Symbol.hasInstance]?e[Symbol.hasInstance](t):t instanceof e}</span>function <span class="fstat-no" title="function not covered" >_toConsumableArray(</span>t){<span class="cstat-no" title="statement not covered" >return _arrayWithoutHoles(t)||_iterableToArray(t)||_nonIterableSpread()}</span>function <span class="fstat-no" title="function not covered" >_nonIterableSpread(</span>){<span class="cstat-no" title="statement not covered" >throw new TypeError("Invalid attempt to spread non-iterable instance")}</span>function <span class="fstat-no" title="function not covered" >_iterableToArray(</span>t){<span class="cstat-no" title="statement not covered" >if(Symbol.iterator in Object(t)||"[object Arguments]"===Object.prototype.toString.call(t))<span class="cstat-no" title="statement not covered" >return Array.from(t)}</span></span>function <span class="fstat-no" title="function not covered" >_arrayWithoutHoles(</span>t){<span class="cstat-no" title="statement not covered" >if(Array.isArray(t)){<span class="cstat-no" title="statement not covered" >for(var e=0,r=new Array(t.length);e&lt;t.length;e++)<span class="cstat-no" title="statement not covered" >r[e]=t[e];<span class="cstat-no" title="statement not covered" >r</span></span>eturn r}</span>}</span>function <span class="fstat-no" title="function not covered" >_typeof(</span>t){<span class="cstat-no" title="statement not covered" >return(_typeof="function"==typeof Symbol&amp;&amp;"symbol"==typeof Symbol.iterator?<span class="fstat-no" title="function not covered" >fu</span>nction(t){<span class="cstat-no" title="statement not covered" >return typeof t}</span>:<span class="fstat-no" title="function not covered" >fu</span>nction(t){<span class="cstat-no" title="statement not covered" >return t&amp;&amp;"function"==typeof Symbol&amp;&amp;t.constructor===Symbol&amp;&amp;t!==Symbol.prototype?"symbol":typeof t}</span>)(t)}</span>var Scrambler=<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction(t){<span class="cstat-no" title="statement not covered" >try{var e=<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction(t){var e=<span class="cstat-no" title="statement not covered" >t||1,</span>r=<span class="cstat-no" title="statement not covered" >Math.random().toString(36).replace(/[^a-z]+/g,"").substr(0,e);<span class="cstat-no" title="statement not covered" ></span>if(" \t\n\r\v".indexOf(r)&lt;0)<span class="cstat-no" title="statement not covered" >return r}</span></span>,</span>r=<span class="cstat-no" title="statement not covered" >!!(o=t)&amp;&amp;o.constructor===Object||"object"==_typeof(t);<span class="cstat-no" title="statement not covered" ></span>r&amp;&amp;(t.target=void 0!==t.target&amp;&amp;r?t.target:"[data-scrambler]",t.random=void 0!==t.random&amp;&amp;r?t.random:[1e3,3e3],t.speed=void 0!==t.speed&amp;&amp;r?t.speed:100,t.text=!(void 0===t.text||!r)&amp;&amp;t.text);v</span>ar n=<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction(){<span class="cstat-no" title="statement not covered" >return r?t.random[0]+(Math.random()*(1-t.random[1])+t.random[1]):-2999*Math.random()+3e3+1e3}</span>;<span class="cstat-no" title="statement not covered" ></span>!<span class="fstat-no" title="function not covered" >fu</span>nction(t){<span class="cstat-no" title="statement not covered" >_toConsumableArray(r?document.querySelectorAll(t.target):document.querySelectorAll(t)).forEach(<span class="fstat-no" title="function not covered" >fu</span>nction(r,o){<span class="cstat-no" title="statement not covered" >if("true"!==r.getAttribute("data-scramble-active")){<span class="cstat-no" title="statement not covered" >r.setAttribute("data-scramble-active","true");v</span>ar a=<span class="cstat-no" title="statement not covered" >r.textContent.split(""),</span>i=<span class="cstat-no" title="statement not covered" >r.innerHTML,</span>c=<span class="cstat-no" title="statement not covered" >a,</span>u=<span class="cstat-no" title="statement not covered" >r.textContent.split(""),</span>l=<span class="cstat-no" title="statement not covered" >[],</span>f=<span class="cstat-no" title="statement not covered" >t.speed?t.speed:100,</span>s=<span class="cstat-no" title="statement not covered" >!1,</span>b=<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >fu</span>nction(t){var n=<span class="cstat-no" title="statement not covered" >t||r.textContent;<span class="cstat-no" title="statement not covered" ></span>a=n.split(""),u=n.split(""),c=[],a.forEach(<span class="fstat-no" title="function not covered" >fu</span>nction(t,r){<span class="cstat-no" title="statement not covered" >" \t\n\r\v".indexOf(a[r])&gt;-1?c.push(" "):c.push(e())}</span>),c=c}</span>;<span class="cstat-no" title="statement not covered" ></span>t.text&amp;&amp;""!==t.text&amp;&amp;("string"==typeof t.text||_instanceof(t.text,String))?(b(t.text),s=!0):r.getAttribute("data-scramble-text")&amp;&amp;""!==r.getAttribute("data-scramble-text")&amp;&amp;(b(r.getAttribute("data-scramble-text")),s=!0);v</span>ar d=<span class="cstat-no" title="statement not covered" >setInterval(<span class="fstat-no" title="function not covered" >fu</span>nction(){<span class="cstat-no" title="statement not covered" >if(c.map(<span class="fstat-no" title="function not covered" >fu</span>nction(t,o){<span class="cstat-no" title="statement not covered" >" \t\n\r\v".indexOf(t)&gt;-1||(u[o]=e(),setTimeout(<span class="fstat-no" title="function not covered" >fu</span>nction(){<span class="cstat-no" title="statement not covered" >l[o]=!0}</span>,n()),!0===l[o]&amp;&amp;(u[o]=a[o]),r.textContent=u.join(""))}</span>),u.length==a.length&amp;&amp;u.every(<span class="fstat-no" title="function not covered" >fu</span>nction(t,e){<span class="cstat-no" title="statement not covered" >return t===a[e]}</span>)){<span class="cstat-no" title="statement not covered" >if(r.innerHTML=i,s){var t=<span class="cstat-no" title="statement not covered" >r.children[0];<span class="cstat-no" title="statement not covered" ></span>t&amp;&amp;""!==t?t.textContent=u.join(""):r.textContent=u.join("")}<span class="cstat-no" title="statement not covered" ></span>c</span>learInterval(d),r.setAttribute("data-scramble-active","false")}</span>}</span>,f)}</span>}</span>)}</span>(t)}</span>catch(t){<span class="cstat-no" title="statement not covered" >console.trace("%cuh-oh: %c"+t,"color:indianred;","color:cornflowerblue;")}</span>v</span>ar o};</span>
